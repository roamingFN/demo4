	...
	if (mysql_num_rows($select_return)>0) {
		...
		while ($row = mysql_fetch_array($select_return)) {
			echo "<tr>
							...
							<td>".number_format($row['pay_unitprice'],2)."</td>
