...
if ($url == "") {
	...
	$requestUrl = 'http://otapi.net/OtapiWebService2.asmx/BatchGetItemFullInfo?instanceKey=' . CFG_SERVICE_INSTANCEKEY
	...
	echo "<div style='margin-bottom:0px;' class='form-group'>
					...
					<div style='text-align:left;' class='col-sm-10 control-label' >
						<span id='product_name'>".(string)$itemInfo->Title."</span>
					</div>
				</div>";
